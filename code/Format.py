    ...
    def generate(self, data):
        try:
            ...
            for key in data:
                ...
                printProgressBar(progress_cnt + 1, progress_length, prefix='VOC Generate:'.ljust(15), suffix='Complete',
                                 length=40)
                progress_cnt += 1
    ...
    def save(xml_list, path):
        ...
        try:
            ...
            for key in xml_list:
                ...
                printProgressBar(progress_cnt + 1, progress_length, prefix='VOC Save:'.ljust(15), suffix='Complete',
                                 length=40)
                progress_cnt += 1
    ...
    def parse(path):
        try:
            ...
            for filename in filenames:
                ...
                printProgressBar(progress_cnt + 1, progress_length, prefix='VOC Parsing:'.ljust(15), suffix='Complete',
                                 length=40)
                progress_cnt += 1
            ...
            with open("box_groups.txt", "w") as bboxGroups:
                ...
                for filename in filenames:
                    ...
                    for line in txt:
                        ...
                        bboxGroups.write("{} {} {} {}\n".format(float(xmin), float(ymin), float(xmax) - float(xmin),
