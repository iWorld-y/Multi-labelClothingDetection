...
for num in tqdm(range(1, num_images + 1)):
    json_name = '/home/eugene/dataSet/DeepFashion2/validation/annos/' + str(num).zfill(6) + '.json'
    image_name = '/home/eugene/dataSet/DeepFashion2/validation/image/' + str(num).zfill(6) + '.jpg'
