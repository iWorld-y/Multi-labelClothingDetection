...
data_root = r"/root/autodl-tmp/DeepFashion2"
for data_type in ["train", "validation"]:
    train_or_val_path = os.path.join(data_root, data_type)
    num_images = len(os.listdir(os.path.join(train_or_val_path, "annos")))

    for num in tqdm(range(1, num_images + 1)):
        json_name = os.path.join(
            train_or_val_path, "annos", f"{num:06d}.json")
        
        image_name = os.path.join(
            train_or_val_path, "images", f"{num:06d}.jpg")
